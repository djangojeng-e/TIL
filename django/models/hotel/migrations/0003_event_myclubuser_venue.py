    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attendees', models.ManyToManyField(to='hotel.MyclubUser')),
                ('venue', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hotel.Venue')),
            ],
        ),
    ]
